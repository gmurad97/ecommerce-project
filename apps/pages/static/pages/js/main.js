...
(function ($) {
  ...
  if (localStorage.getItem('dark_mode') === 'enabled') {
    $('html').addClass('dark_mode'); // Добавляем класс
    $('#flexSwitchCheckDefault').prop('checked', true); // Включаем свитчер
  }
  ...
  $('#flexSwitchCheckDefault').on('change', function() {
    if ($(this).is(':checked')) {
      ...
      localStorage.setItem('dark_mode', 'enabled'); // Сохраняем в LocalStorage
    } else {
      $('html').removeClass('dark_mode');
      localStorage.setItem('dark_mode', 'disabled'); // Удаляем из LocalStorage
    }
  });
